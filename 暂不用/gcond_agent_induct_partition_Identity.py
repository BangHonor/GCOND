...
class GCond:
    ...
    def test_with_val(self,part_index,part,it,verbose=True):
        ...
        model.fit_with_val(feat_syn, adj_syn, labels_syn, data,#use syn graph, val data to train model
                     train_iters=600, normalize=True, verbose=False, noval=noval, identity=True)
        model.eval()
        ...
        for it in range(args.epochs+1):#1000训练小图
            ...
            for ol in range(outer_loop):
                ...
                for c in range(data.nclass):
                    ...
                    output_syn = model.forward(feat_syn[ind[0]: ind[1]], adj_syn, identity=True)
                ...
                for j in range(inner_loop):
                    ...
                    output_syn_inner = model.forward(feat_syn_inner_norm, adj_syn_inner_norm, identity=True)
            ...
            eval_epochs = [0, 100, 200, 400, 600, 800, 1000]
