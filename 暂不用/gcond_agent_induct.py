...
class GCond:
    ...
    def test_with_val(self, verbose=True):
        ...
        noval = True
        model.fit_with_val(args, feat_syn, adj_syn, labels_syn, data,
        ...
        torch.save(model.parameters(), f'saved_ours/ModelPara_{args.dataset}_{args.reduction_rate}_{args.seed}.pt')
        return res
    ...
    def train(self, verbose=True):
        ...
        print("feat_syn",feat_syn.shape,"feat_sub",feat_sub.shape)
        self.feat_syn.data.copy_(feat_sub)#syn是train*redcution_rate 
        ...
        for it in range(args.epochs+1):
            ...
            eval_epochs = [0, 100, 200, 400, 600, 800, 1000, 1200, 1400, 1600, 1800, 2000]
